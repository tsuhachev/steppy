...
function init() {
    //init data
    var json = {"children":[{"children":[],"data":{"progress":100,"tests":3,"pending":0,"$color":"#00ff00","$area":13,"steps":13,"failing":0,"type":"tag","passing":3},"id":"departure test","name":"departure test"}],"data":{},"id":"root","name":"Application"};
    //end
    //init TreeMap
